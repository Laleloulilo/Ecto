...
<head>
    ...
    "Mini-CMS, 0 dépendance, - de 100 ko, Markdown, Déploiement Copier/coller">
    ...
    <title>Accueil : Ecto</title>
</head>
<body>
<div class="contenu container-fluid">
    <h1 id='titre_accueil'>Ecto</h1>
    <p class='sous-titre lead'>Mini-CMS, 0 dépendance, - de 100 ko,
        Markdown, Déploiement Copier/coller</p>
    <article>
        <header>
            <h2><small><a href='Article-Dans-Categorie.php'>Article Dans
                        Catégorie</a></small></h2>
            <small>22 June 2020 • <em>Catégorie</em> • ☕️ 1
                minute</small></header>
        <p>Premier article d'une catégorie</p>
    </article>
    <article>
        <header>
            <h2><small><a href='Bienvenue.php'>Bienvenue</a></small></h2>
            <small>12 June 2020 • <em>Notes</em> • ☕️ 2
